...
if [ $1 == "1" ]; then
  #TF_CONFIG='{"cluster": {"worker": ["83.212.80.22:2222"]}, "task": {"index": 1, "type": "worker"}}' /home/user/miniconda3/envs/distributed_training/bin/python3 /home/user/distributed-training/test/worker.py
