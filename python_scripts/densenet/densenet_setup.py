...
def natural_dataset():
  ...
  labels=[]
  random.seed(42)
  imagePaths = sorted(list(os.listdir("/home/user/distirbuted-training/natural_images/"))) #thelei allagi sto path
  random.shuffle(imagePaths)
  print(imagePaths)

  for img in imagePaths:
      path=sorted(list(os.listdir("/home/user/distirbuted-training/natural_images/"+img)))
      for i in path:
          image = cv2.imread("/home/user/distirbuted-training/natural_images/"+img+'/'+i)
